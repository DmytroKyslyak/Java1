...
public class Lesson_7_1 {
	public static void main(String[] args) {
		...
		System.out.println("Первая цифра равна последней: " +firstLast(10671));
		System.out.println("Задача 4");
		System.out.println("Факториал: " +fak(5));
		System.out.println("Задача 5");
		System.out.println("В этом месяце дней: " +day5(2,2020));
		System.out.println("Задача 7");
		int [] n7 = {1,2,1,1,1};
		System.out.println("Число повсюду: " +every(n7,1));
		}
